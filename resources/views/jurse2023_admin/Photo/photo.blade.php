    ...
    <div class="row flex-nowrap">
        @include('jurse2023_admin.partials.sidebar')
         <div class="col py-4" id="dynamic-content">
             ...
             @endif
    <form method="post" action="{{ route('admin/medias/photo/store') }}"  enctype="multipart/form-data">
                @csrf
         <div class="d-flex justify-content-between align-items-center mb-3">
                    <h1 class="text-center mb-0">Create New Photo</h1>
         </div>
        <div class="mb-3">
        ...
        <a class="btn btn-primary" href="{{ route('admin/photoslist') }}">List</a>
    </form>
</div>
</div>
</div>
