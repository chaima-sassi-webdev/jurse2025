...
<head>
    ...
    <body class="stretched">
        ...
        <div class="parent vh-50">
            <section id="slider" class="slider-element vh-60" style="background: url('images/heraklion/ima1.jpg') center center; background-size: cover;"><div class="overlay"></div></section>
            <div class="child">
